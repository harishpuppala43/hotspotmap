...
var style_Cummulativescoreofregion_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.000000 && value <= 0.029617) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.029617 && value <= 0.062718) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.062718 && value <= 1.000000) {
            style = [ new ol.style.Style({
